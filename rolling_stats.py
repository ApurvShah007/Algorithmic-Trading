...
#Assumes that the csv file is in the same folder as this file. 
...
#This function accepts 3 parameters. df - the historic dataframe of the stock, date- the daterange for the plot, plot - a boolean for whether the user 
#wants to see the plot or just wants the resulting dataframe.  
